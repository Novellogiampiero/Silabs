...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SYS_CLOCK_HW_CYCLES_PER_SEC, 39000000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_SILABS_GECKO_PINCTRL_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_AUTEC_DIR_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_AUTECRADIO, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_AUTECRADIO_EFR32ZG23B020F512IM48, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_SERIES_EFR32ZG23, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_PART_NUMBER_EFR32ZG23B020F512IM48, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CMU_NEED_LFXO, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CMU_HFCLK_LFXO, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_GECKO_HAS_RADIO, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_GECKO_USE_RAIL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_GECKO_CUSTOM_RADIO_PHY, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PINCTRL_GECKO, 1);
