...
static const uint32_t phyInfo[] = {
  17UL,
  0x0011F704UL, // 17.964912280701753
  (uint32_t) NULL,
...
const uint32_t Autec_packet_generico_test_10byte_payload_modemConfigBase[] = {
...
const RAIL_ChannelConfigEntry_t Autec_packet_generico_test_10byte_payload_channels[] = {
  {
...
const RAIL_ChannelConfig_t Autec_packet_generico_test_10byte_payload_channelConfig = {
  .phyConfigBase = Autec_packet_generico_test_10byte_payload_modemConfigBase,
  .phyConfigDeltaSubtract = NULL,
  .configs = Autec_packet_generico_test_10byte_payload_channels,
  .length = 1U,
  .signature = 0UL,
...
const RAIL_ChannelConfig_t *channelConfigs[] = {
  &Autec_packet_generico_test_10byte_payload_channelConfig,
  NULL
};

uint32_t autecAccelerationBuffer[471];
